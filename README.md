...
## 5. 느낌 및 보완방향
호텔앱 리뷰를 한국어 자연어 처리해본 결과 많은것을 느낄 수 있었다.<br>
다양한 리뷰 데이터를 학습 데이터로 구축하고 학습시켜 모델을 적용하여<br>
학습 정확도와 검증 정확도가 굉장히 높게 나와서 많이 놀라웠고 제대로 학습<br>
되었다는 사실에 많이 기뻤다. 이번 프로젝트를 진행 하면서 더욱 보완할 점은<br>
데이터를 학습 데이터로 구축하는 과정에서 어떻게 해야할지 몰라 많이 해메었는데<br>
앞으로는 학습 데이터의 기준을 세워야할 것 같다.<br>
